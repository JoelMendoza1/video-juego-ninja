...
class Ninja(pygame.sprite.Sprite):
    ...
    def dibujarFondoDerecha (self, superficie):
        ...
        if self.contadorpasos ==22:
            puntaje +=30
            
        if self.contadorpasos ==38:
            puntaje +=30
...
def Gaiden():
    ...
    while enJuego ==True :
        ...
        if jugador.rect.colliderect(enemigo.rect) or jugador.rect.colliderect(enemigo.rect2) or jugador.rect.colliderect(enemigo.rect3)or jugador.rect.colliderect(enemigo.rect4)or jugador.rect.colliderect(enemigo.rect5)or jugador.rect.colliderect(enemigo.rect6):
